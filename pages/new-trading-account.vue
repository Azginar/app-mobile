...
.light-theme .open-trading-account-page h1,
.light-theme .open-trading-account-page .form-block h4
{
  color: #000000;
}

.light-theme .open-trading-account-page .check-box .text-block a
{
  color: #989898;
}
</style>
