<template>
  <div class="login-authorization-page registration-page">
    ...
    <form :onsubmit="handleSubmit" class="login-form-container">
      ...
      <div class="row-line">
        <label>Referal UID</label>
        <black-input
          :attribute="'full-name'"
        />
      </div>
      <div class="hint-text">
        <p>Enter the UID of your partner here (optional)</p>
      </div>
        ...
        <div class="check-box">
          <div class="check-box-content">
            ...
            <div class="text-block">
              I have read and agree to the <span style="color: #B2B2B2;">Clients Agreement</span>
            </div>
          </div>
        </div>
      </div>
...
import BlackInputPassword from '../components/black-input-password'
import SimpleSelectBlackWithIcon from '../components/SimpleSelectBlackWithIcon'
import { GET_COUNTRY_LIST, GET_SELECTED_COUNTRY_LIST } from '../modules/registration/getter-types'
import { CHANGE_SELECTED_COUNTRY_LIST } from '../modules/registration/mutation-types'
...
export default {
  ...
  computed: {
    ...
    countryList () {
      return this.$store.getters[`registration/${GET_COUNTRY_LIST}`]
    },
    selectedCountryList () {
      return this.$store.getters[`registration/${GET_SELECTED_COUNTRY_LIST}`]
    }
  },
  ...
  methods: {
    ...
    changeCountry (selected) {
      return this.$store.commit(`registration/${CHANGE_SELECTED_COUNTRY_LIST}`, selected)
    }
  }
}
</script>
<style>
  ...
  .registration-page .check-box-content
  {
  ...
  .registration-page .button-switch
  {
    margin-right: 10px;
  }

  .registration-page .check-box .text-block
  {
  ...
  .login-authorization-page .hint-text {
    padding-left: 20px;
    padding-top: 10px;
