<template>
  <div class="finance-page electronic-systems-page">
    ...
    <deposit-method :payment-methods="ELECTRONIC_SYSTEMS_DATA" />
  </div>
</template>
<script>
...
.electronic-systems-page .container-card .block-card .wrapper-img
{
  height: auto;
}

.light-theme .finance-page h3
{
  color: #000000;
}
</style>
