<template>
  <div class="bank-card-withdrawal-page-view">
    ...
    <div class="card-block-wrap">
      <div v-if="GET_BANK_CARD_NUMBER_FOR_WITHDRAWAL" class="description-block">
        <div v-if="isTypeBankCardMasterCard(GET_BANK_CARD_NUMBER_FOR_WITHDRAWAL.typeCard)" class="img-block mastercard">
          <icMasterCard />
        </div>
...
export default {
  ...
  mounted () {
    this[CHANGE_BANK_CARD_FOR_WITHDRAWAL](this.$route.params.id)
  }
}
</script>
<style>
.bank-card-withdrawal-page-view
{
  padding: 40px 20px 60px;
}

.bank-card-withdrawal-page-view h3
{
...
.bank-card-withdrawal-page-view input::-webkit-input-placeholder
{
  text-align: right;
  font-family: Arial;
  font-style: normal;
...
.bank-card-withdrawal-page-view input::-moz-placeholder
{
  text-align: right;
  font-family: Arial;
  font-style: normal;
...
.bank-card-withdrawal-page-view .img-block
{
  text-align: center;
  margin-bottom: 20px;
}

.bank-card-withdrawal-page-view .mastercard svg
{
  width: 120px;
  height: 74px;
}

.bank-card-withdrawal-page-view .text-block h4
{
  font-family: Montserrat;
  font-style: normal;
  font-weight: 600;
...
.bank-card-withdrawal-page-view .form-card .row-line
{
  margin-bottom: 20px;
}

.bank-card-withdrawal-page-view .go-back-button
{
  margin-bottom: 40px;
}

.bank-card-withdrawal-page-view .go-back-button button
{
  background: #333333;
...
.bank-card-withdrawal-page-view .go-back-button .back-button svg
{
  fill: #B2B2B2;
}

.bank-card-withdrawal-page-view .only-text p
{
  font-family: Arial;
  font-style: normal;
  font-weight: normal;
...
.bank-card-withdrawal-page-view .only-text p span
{
  color: #B2B2B2;
}

.bank-card-withdrawal-page-view label
{
  font-family: Montserrat;
  font-style: normal;
  font-weight: 600;
...
.bank-card-withdrawal-page-view .card-block-wrap .btn-block
{
  text-align: center;
  margin-top: 40px;
}

.bank-card-withdrawal-page-view .card-block-wrap .btn-block button
{
  font-size: 15px;
  line-height: 15px;
...
.light-theme .bank-card-withdrawal-page-view h3,
.light-theme .bank-card-withdrawal-page-view .text-block h4
{
  color: #000000;
}
