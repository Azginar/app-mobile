...
import { GET_PERIOD_CAMPAIGN_SELECTED } from '@/modules/affiliate/getter-types'
import { SET_SELECTED_PERIOD_CAMPAIGN } from '@/modules/affiliate/mutation-types'
...
export default {
  ...
  methods: {
    ...
    isPeriodSelected (period) {
      return this[GET_PERIOD_CAMPAIGN_SELECTED] === period
    },
    setSelectedPeriod (period) {
      this[SET_SELECTED_PERIOD_CAMPAIGN](period)
    },
    handleSelectCustomPeriod () {
      this.setSelectedPeriod('CUSTOM_PERIOD')
      this.$router.push('/affiliate/custom-filter-period-campaign')
    }
